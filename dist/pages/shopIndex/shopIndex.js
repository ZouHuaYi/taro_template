...
var ShopIndex = (_temp2 = _class = function (_BaseComponent) {
  ...
  function ShopIndex() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ShopIndex.__proto__ || Object.getPrototypeOf(ShopIndex)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
