...
var AreaList = (_temp2 = _class = function (_BaseComponent) {
  ...
  function AreaList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AreaList.__proto__ || Object.getPrototypeOf(AreaList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
