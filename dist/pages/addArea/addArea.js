...
var AddArea = (_temp2 = _class = function (_BaseComponent) {
  ...
  function AddArea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddArea.__proto__ || Object.getPrototypeOf(AddArea)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
